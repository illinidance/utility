...
tempos = {
'standard': {'waltz': 87, 'tango': 64, 'Viennese waltz': 174, 'foxtrot':112, 'quickstep':200},
'latin': {'cha cha': 124, 'samba': 100, 'rumba': 104, 'paso doble':110, 'jive':172},
'smooth': {'waltz': 90, 'tango': 60, 'Viennese waltz': 159, 'foxtrot':120, 'peabody':240},
'rhythm': {'cha cha': 120, 'swing': 140, 'rumba': 124, 'bolero':88, 'mambo':188, 'samba': 100, 'merengue': 60, 'paso doble': 110, 'WC swing': 120, 'polka':120, 'hustle':120},
}

beats_per_measure = {
'standard': {'waltz': 3, 'tango': 2, 'Viennese waltz': 3, 'foxtrot':4, 'quickstep':4},
'latin': {'cha cha': 4, 'samba': 2, 'rumba': 4, 'paso doble':2, 'jive':4},
'smooth': {'waltz': 3, 'tango': 2, 'Viennese waltz': 3, 'foxtrot':4, 'peabody':4},
'rhythm': {'cha cha': 4, 'swing': 4, 'rumba': 4, 'bolero':4, 'mambo':4, 'samba': 2, 'merengue': 2, 'paso doble': 2, 'WC swing': 4, 'polka':2, 'hustle':4},
}
...
def classify_song(bpm, meter, name, categories, threshold=0.1):
    ...
    for style in tempos:
        for dance in tempos[style]:
            ...
            if bpm > tempo_min and bpm < tempo_max and (smeter == meter or 2*smeter == meter or smeter == 2*meter):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_folder', type=str, default=None, help='Directory to save downloaded songs. Don\'t use for a temporary directory.')
    parser.add_argument('--finput', type=str, default='example_song_list.txt', help='The input URL file.')
    parser.add_argument('--foutput', type=str, default='example_song_list_categories.txt', help='The output txt file.')
    ...
    file_names = [f for f in os.listdir(store_dir) if osp.isfile(osp.join(store_dir, f))]
